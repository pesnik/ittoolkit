...
export function McpServersPanel() {
    ...
    const [probeResult, setProbeResult] = useState<Record<string, McpToolDef[] | string>>({});
        ...
        <div className={styles.root}>
            <div>
                ...
                <Text size={200} block style={{ color: tokens.colorNeutralForeground3, marginTop: '4px' }}>
                    ...
                    the name <code>{'<server-id>__<tool>'}</code>. Edit
                    ...
                    {probeResult[id] !== undefined && (
                        <div className={styles.toolList}>
                            {Array.isArray(probeResult[id])
                                ? (probeResult[id] as McpToolDef[]).length === 0
                                    ? '(no tools exposed)'
                                    : (probeResult[id] as McpToolDef[])
