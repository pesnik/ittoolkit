...
/**
 * ComputerView — main-pane viewport for the computer-use harness (CU-M2).
 *
 * Subscribes to `computer-view-update` events the inference loop dispatches
 * after each `computer_screenshot`, and to `permission-warning` events when
 * macOS Accessibility / Screen Recording grants are missing. Phase 2 / CU-M3
 * will extend this with the in-flight kill switch overlay; for now the view
 * is read-only.
 */
                ...
                {state.screenshot ? (
                    ...
                    <div className={styles.empty}>
                        ...
                        <Text>
                            ...
                            (e.g. <em>“What window am I looking at right now?”</em>) and the
