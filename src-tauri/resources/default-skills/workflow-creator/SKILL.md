...
**Tool hierarchy (see AGENTS.md):** Prefer CLI/AppleScript/PowerShell first, then browser, then computer-use as last resort. Platform-specific CLI patterns are in AGENTS.md.
