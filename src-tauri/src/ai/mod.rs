...
pub struct ChatMessage {
    ...
    /// Base64-encoded JPEG screenshots attached to this message (computer-use
    /// vision payload). Vision-capable models receive these as content[].image_url
    /// blocks; non-vision providers drop them.
